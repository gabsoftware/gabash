    ...
    switch ($ModuleName.ToLowerInvariant()) {
        ...
        "git" {
            return @(
                ...
                [pscustomobject]@{ Command = "gsb"; Description = "git switch (branches)" },
                [pscustomobject]@{ Command = "gd"; Description = "git diff" },
                [pscustomobject]@{ Command = "gf"; Description = "git fetch --all" },
                [pscustomobject]@{ Command = "gr"; Description = "git restore (files/paths)" },
                [pscustomobject]@{ Command = "grs"; Description = "git reset" },
